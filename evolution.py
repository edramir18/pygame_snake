...
class Evolution:
    ...
    def selection(self):
        ...
        np.random.shuffle(self.parent_ids)
    ...
    def crossover(self):
        ...
        for i in range(self.population - self.elite):
            ...
            cross0 = np.random.choice(a, l0, p=p)
    ...
    def mutation(self):
        ...
        for i in range(self.population - self.elite):
            mut0 = np.random.choice(a, l0, p=p)
            cro0 = 2 * np.random.random(l0) - 1
            mut1 = np.random.choice(a, l1, p=p)
            cro1 = 2 * np.random.random(l1) - 1
            mut2 = np.random.choice(a, l2, p=p)
            cro2 = 2 * np.random.random(l2) - 1
